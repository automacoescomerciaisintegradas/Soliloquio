...
function mensagemErroChat(error: SupabaseErroBasico | null | undefined, fallback: string) {
  ...
  if (
    ...
    return "Banco de dados não configurado. Execute o arquivo shared/supabase-setup-completo.sql no SQL Editor do Supabase e tente novamente.";
  }
...
export default function Chat() {
  ...
  const sincronizarPerfilAtual = async () => {
    ...
    const mensagem = String(tentativaPadrao.error.message || "").toLowerCase();
    if (!mensagem.includes("user_id")) {
  ...
  return (
    <main className="min-h-screen bg-slate-100 p-3 md:p-6">
      <div className="mx-auto max-w-6xl space-y-3 md:space-y-4">
        ...
        {carregandoTela ? (
          <div className="flex min-h-[50vh] items-center justify-center rounded-xl bg-white">
          ...
          <section className="grid gap-3 md:grid-cols-[320px_1fr] md:gap-4">
            <aside className="rounded-xl bg-white p-3 shadow-sm md:p-4">
                  ...
                  {usuariosOrdenados.map(item => {
                    ...
                    return (
                      <button
                        ...
                        className="w-full rounded-lg border border-slate-200 px-3 py-2 text-left hover:border-blue-300 hover:bg-blue-50"
                      >
                ...
                <div className="space-y-4">
                  <form onSubmit={enviarDocsParaWebhook} className="space-y-3">
                    ...
                    <input
                      ...
                      className="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 placeholder:text-slate-500 caret-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500/40"
                      required
                    />
                    <input
                      type="email"
                    ...
                    <textarea
                      ...
                      className="min-h-20 w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 placeholder:text-slate-500 caret-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500/40"
                    />
                    <input
                      type="file"
                      accept="application/pdf,image/*,video/*,audio/*,.zip,.rar,.doc,.docx"
                      onChange={e => setDocArquivo(e.target.files?.[0] ?? null)}
                      className="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500/40"
                    />
                    {contatoAtivo && (
                  ...
                  <div className="rounded-lg border border-slate-200 bg-slate-50 p-3">
                    ...
                    <textarea
                      ...
                      className="min-h-44 w-full rounded-md border border-slate-300 bg-white p-2 text-xs text-slate-700"
                    />
              ...
              {abaLateral === "meta" && (
                <form onSubmit={salvarCadastroMeta} className="space-y-3">
                  ...
                  <input
                    ...
                    className="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/40"
                    required
                    disabled={!isAdmin}
                  />
                  ...
                  <textarea
                    ...
                    className="min-h-20 w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/40"
                    required
                    disabled={!isAdmin}
                  />
              ...
              {abaLateral === "docs" && !isAdmin && !carregandoPermissaoAdmin && (
                <form onSubmit={enviarComprovantePagamento} className="space-y-3">
                  ...
                  <select
                    ...
                    className="w-full rounded-md border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500/40"
                  >
            ...
            <section className="flex min-h-[60vh] flex-col rounded-xl bg-white shadow-sm">
              <div className="border-b border-slate-200 px-4 py-3">
                <p className="text-sm text-slate-600">Conversa ativa</p>
                      ...
                      >
                        ...
                        <p
                          className={`mt-1 text-[11px] ${
                            minhaMensagem ? "text-blue-100" : "text-slate-500"
                          }`}
                        >
